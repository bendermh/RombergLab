...
-(NSArray *)getScores:(float)area1 :(float)area2 :(float)area3 :(float)area4{
    ...
    float ScoreVestibular = ((2.572-preScoreVestibular)/2.572);
    float ScoreVisual = ((2.043-preScoreVisual)/2.043);
    float ScoreSomatosensorial = (1.614-preScoreSomatosensorial)/1.614;
...
-(float)limiteVestibular:(int)ageGroup :(int)heightGroup{
    ...
    vestibularSdMatrix[0][0] = 0.200f;
    vestibularSdMatrix[0][1] = 0.200f;
    vestibularSdMatrix[0][2] = 0.200f;
    vestibularSdMatrix[0][3] = 0.175f;
    vestibularSdMatrix[1][0] = 0.200f;
    vestibularSdMatrix[1][1] = 0.200f;
    vestibularSdMatrix[1][2] = 0.200f;
    vestibularSdMatrix[1][3] = 0.175f;
    vestibularSdMatrix[2][0] = 0.200f;
    vestibularSdMatrix[2][1] = 0.200f;
    vestibularSdMatrix[2][2] = 0.200f;
    vestibularSdMatrix[2][3] = 0.175f;
    vestibularSdMatrix[3][0] = 0.200f;
    vestibularSdMatrix[3][1] = 0.200f;
    vestibularSdMatrix[3][2] = 0.200f;
    vestibularSdMatrix[3][3] = 0.175f;
    //Limit Calculation
...
-(float)limiteVisual:(int)ageGroup :(int)heightGroup{
    ...
    visualMeanMatrix[0][0] = 0.600f;
    visualMeanMatrix[0][1] = 0.600f;
    visualMeanMatrix[0][2] = 0.600f;
    visualMeanMatrix[0][3] = 0.600f;
    visualMeanMatrix[1][0] = 0.600f;
    visualMeanMatrix[1][1] = 0.600f;
    visualMeanMatrix[1][2] = 0.600f;
    visualMeanMatrix[1][3] = 0.600f;
    visualMeanMatrix[2][0] = 0.600f;
    visualMeanMatrix[2][1] = 0.600f;
    visualMeanMatrix[2][2] = 0.600f;
    visualMeanMatrix[2][3] = 0.600f;
    visualMeanMatrix[3][0] = 0.600f;
    visualMeanMatrix[3][1] = 0.600f;
    visualMeanMatrix[3][2] = 0.600f;
    visualMeanMatrix[3][3] = 0.600f;
    float visualSdMatrix[4][4];
    //adjusted id > 0.2 = 0.2
    visualSdMatrix[0][0] = 0.200f;
    visualSdMatrix[0][1] = 0.200f;
...
-(float)limiteSomatosensorial:(int)ageGroup :(int)heightGroup{
    ...
    somatosensorialMeanMatrix[0][0] = 0.450f;
    somatosensorialMeanMatrix[0][1] = 0.600f;
    somatosensorialMeanMatrix[0][2] = 0.450f;
    somatosensorialMeanMatrix[0][3] = 0.400f;
    somatosensorialMeanMatrix[1][0] = 0.450f;
    somatosensorialMeanMatrix[1][1] = 0.600f;
    somatosensorialMeanMatrix[1][2] = 0.450f;
    somatosensorialMeanMatrix[1][3] = 0.400f;
    somatosensorialMeanMatrix[2][0] = 0.450f;
    somatosensorialMeanMatrix[2][1] = 0.600f;
    somatosensorialMeanMatrix[2][2] = 0.450f;
    somatosensorialMeanMatrix[2][3] = 0.400f;
    somatosensorialMeanMatrix[3][0] = 0.450f;
    somatosensorialMeanMatrix[3][1] = 0.600f;
    somatosensorialMeanMatrix[3][2] = 0.450f;
    somatosensorialMeanMatrix[3][3] = 0.400f;
    float somatosensorialSdMatrix[4][4];
    //adjusted if > 0.2 = 0.2 and if < 0.05 = 0.05
    somatosensorialSdMatrix[0][0] = 0.150f;
    somatosensorialSdMatrix[0][1] = 0.200f;
